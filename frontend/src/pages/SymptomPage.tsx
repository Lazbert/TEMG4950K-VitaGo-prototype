...
const symptoms: Array<SymptomItemProps> = [
  ...
  // { stat: 12, unit: "minutes", symptom: "Fatigue" },
  ...
  return (
    <>
      <TitleSection
        ...
        allowLastPage
      />
      <ContentSection className="h-full pb-[245px]" overflow>
      ...
      <div className="flex flex-col bg-white gap-[14px] py-[17px] items-center bottom-0 absolute border-t border-grey/30 w-full h-[220px]">
        <button
          onClick={() => nav("/VitaGo/booking", { state: "specialist" })}
